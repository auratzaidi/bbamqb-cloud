...
def page(title, body, user=None):
    ...
    if user:
        if user.get("role") == "ROLE_OPERATOR":
            ...
            menu = "<a href='/'>Dashboard</a><a href='/clients'>Clients</a><a href='/client/new'>Single Entry</a><a href='/client/multi'>7 Name Entry</a><a href='/search'>Search</a><a href='/operator-summary'>Operator Summary</a><a href='/trash'>Deleted Entries</a><a href='/report'>Report</a><a href='/export.csv'>SMS Excel Export</a><a href='/users'>Users</a><a href='/logout'>Logout</a>"
...
class App(BaseHTTPRequestHandler):
    ...
    def dashboard(self,u):
        ...
        <div class='card'><a class='btn' href='/clients'>Search Entries</a><a class='btn gold' href='/operator-summary'>Operator Summary</a><a class='btn secondary' href='/export.csv'>SMS Excel Export</a></div>"""
        self.sendx(200, {"Content-Type":"text/html; charset=utf-8"}, page("Dashboard",body,u))
    ...
    def export_csv(self):
        # ADMIN ONLY: Excel export for bulk SMS.
        # Numbers stacked in 7 columns.
        u = self.user()
        ...
        temp_path = "/tmp/bbamqb_sms_numbers.xlsx"
        wb.save(temp_path)
        ...
        self.sendx(
            200,
            {
                ...
                "Content-Disposition":"attachment; filename=bbamqb_sms_numbers.xlsx"
            },
            data
        )
